...
export default {
  ...
  trigger (stimulus) {
    ...
    // this.store.dispatch(score.actions.add(stimulus.points || 1))
    ...
    // this.store.dispatch(recent.actions.add(stimulus))
    // this.store.dispatch(predictor.actions.learn(stimulus))
