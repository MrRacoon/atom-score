...
export const initialLast   = () => last.constants.INITIAL_STATE;
export const initialRecent = () => recent.constants.INITIAL_STATE;
...
export const stimulusPoints  = id => (lookupStimulus(id) || {}).points;
